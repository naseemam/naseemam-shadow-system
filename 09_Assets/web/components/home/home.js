(function () {
  const dashboardData = {
    founderOverview: {
      ...
      summary: 'Ameer Workspace is structured around a clear operating shell for focus, momentum, and local execution.'
    },
    priorities: [
      { title: 'Complete the weekly execution plan', meta: 'Keep the focus on the next most important step' },
      { title: 'Review the key notes and decisions', meta: 'Keep memory and projects aligned' }
    ],
    projects: [
      { title: 'Ameer Workspace', meta: 'Core shell and layout framework' },
      { title: 'Founder Operating Model', meta: 'Structure for daily decision support' }
    ],
    tasks: [
      { title: 'Refine the workspace shell', meta: 'Compose the module framework' },
      { title: 'Prepare reusable placeholders', meta: 'Support future workspace modules' }
    ],
    decisions: [
      { title: 'Keep the dashboard as an isolated UI shell', meta: 'Approved for milestone 2' },
      { title: 'Use placeholder content only', meta: 'No backend or business logic' }
    ],
    approvals: [
      { title: 'Home dashboard foundation', meta: 'Pending review' },
      { title: 'Reusable module pattern', meta: 'Open for future modules' }
    ],
    health: [
      { title: 'Workspace shell', meta: 'Ready' },
      { title: 'Local storage state', meta: 'Available' }
    ],
    actions: [
      { title: 'Open a new workspace conversation', meta: 'Start from here' },
      { title: 'Review the workspace modules', meta: 'Switch between sections' }
    ]
  };
    ...
    host.innerHTML = `
      ...
      <div class="dashboard-grid" style="margin-top:12px;">
        <div class="dashboard-card">
          ...
          <div class="subtle">${escapeHtml(dashboardData.founderOverview.summary)}</div>
        </div>
        <div class="dashboard-card">
